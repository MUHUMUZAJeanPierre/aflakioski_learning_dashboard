...
//         ? 'https://course-back-2-00rq.onrender.com/api/login'
//         : 'https://course-back-2-00rq.onrender.com/api/register';
...
//         console.error(`${isLogin ? 'Login' : 'Registration'} failed:`, response.data.message);
//         // You might want to show this error to the user
//       }
//     } catch (error) {
//       console.error(`${isLogin ? 'Login' : 'Registration'} error:`, error.response?.data?.message || 'An error occurred');
